-- 1. Перевод активных студентов на следующий курс.
...
-- 2. Массовое создание записей посещаемости для группы по дисциплине группы.
...
-- 3. Формирование списка должников во временную таблицу temp_debtors.
