-- 1. Расчет среднего балла студента.
...
-- 2. Подсчет количества задолженностей студента: оценки ниже 4 считаются задолженностями.
...
-- 3. Расчет процента посещаемости студента.
